...
qq.UploadHandlerController = function(o, namespace) {
    ...
    upload = {
        cancel: function(id) {
            // log("Cancelling " + id);
            jQuery('.ywgc-custom-image-modal-submit-link').hide();
    ...
    qq.extend(this, {
        ...
        showCancel: function(id) {
            if (!isCancelDisabled) {
                ...
                jQuery('.ywgc-custom-image-modal-submit-link').show();
            }
        },
        ...
        parse: function() {
            var parser = new qq.Promise(),
                onParseFailure = function(message) {
                    //EXIF data could not be parsedqq.format("EXIF header parse failed: '{}' ", message));
