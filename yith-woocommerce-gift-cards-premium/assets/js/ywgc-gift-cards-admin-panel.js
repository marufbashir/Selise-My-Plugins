jQuery(function ($) {
	...
	$(function() {
		if ($('input#ywgc_gift_card_form_on_cart').prop('checked') || $('input#ywgc_gift_card_form_on_checkout').prop('checked')) {
			$('#ywgc_text_before_gc_form').closest('.form-table').prev('h2').removeClass('ywgc-disabled-option');
			$('#ywgc_text_before_gc_form, #ywgc_link_text_before_gc_form, #ywgc_icon_text_before_gc_form, #ywgc_display_form, #ywgc_text_in_the_form, #ywgc_apply_gift_cards_colors, #ywgc_apply_gift_card_button_text, #ywgc_apply_gift_cards_button_colors').closest('.forminp').parent().removeClass('ywgc-disabled-option');
		}});
		...
		$('input#ywgc_gift_card_form_on_cart').change(function() {
			if ( ! $( this ).hasClass( 'onoffchecked') && ! $(this).prop('checked') && ! $('input#ywgc_gift_card_form_on_checkout').prop('checked') ){
				$('#ywgc_text_before_gc_form').closest('.form-table').prev('h2').addClass('ywgc-disabled-option');
				$('#ywgc_text_before_gc_form, #ywgc_link_text_before_gc_form, #ywgc_icon_text_before_gc_form, #ywgc_display_form, #ywgc_text_in_the_form, #ywgc_apply_gift_cards_colors, #ywgc_apply_gift_card_button_text, #ywgc_apply_gift_cards_button_colors').closest('.forminp').parent().addClass('ywgc-disabled-option');
			}
			else{
				$('#ywgc_text_before_gc_form').closest('.form-table').prev('h2').removeClass('ywgc-disabled-option');
				$('#ywgc_text_before_gc_form, #ywgc_link_text_before_gc_form, #ywgc_icon_text_before_gc_form, #ywgc_display_form, #ywgc_text_in_the_form, #ywgc_apply_gift_cards_colors, #ywgc_apply_gift_card_button_text, #ywgc_apply_gift_cards_button_colors').closest('.forminp').parent().removeClass('ywgc-disabled-option');
